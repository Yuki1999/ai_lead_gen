...
Read the scoring rules from `scoring-rules.md` in the same directory. Apply the positive and negative scoring rules, clamp the result to 0–100, and assign a status based on the recommended interpretation table in that file.
